...
\"\n\
checkout_executable TCLSH \"/home/jerry/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/jerry/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
SatMPT  # satellite multipath routing protocol\n\
AOMDV	\n\
...
eval $self next \n\
$self instvar hm_ sscm_ instvar nifs_ phy_tx_ phy_rx_ mac_ ifq_ ll_\n\
set ns [Simulator instance]\n\
set now_ [$ns now]\n\
for {set i 0} {$i < $nifs_} {incr i} {\n\
$phy_tx_($i) reset\n\
...
$node set sscm_ [new StateCheckManager]\n\
$node cmd set_statecheck_mgr [$node set sscm_]\n\
[$node set sscm_] setnode $node\n\
$node create-ragent \n\
